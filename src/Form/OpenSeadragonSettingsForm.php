  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['openseadragon_settings'] = [
      ...
      'fit_to_aspect_ratio' => [
        ...
        '#default_value' => isset($settings['fit_to_aspect_ratio']) ? $settings['fit_to_aspect_ratio'] : 0,
      ...
      'compositeOperation' => [
        ...
        '#default_value' => isset($settings['compositeOperation']) ? $settings['compositeOperation'] : array(),
      ...
      'placeholderFillStyle' => [
        ...
        '#default_value' => isset($settings['placeholderFillStyle']) ? $settings['placeholderFillStyle'] : null,
      ...
      'minZoomLevel' => [
        ...
        '#size' => 10,
        '#element_validate' => [[$this, 'elementValidateNumber']],
        '#default_value' => isset($settings['minZoomLevel']) ? $settings['minZoomLevel'] : null,
      ...
      'maxZoomLevel' => [
        ...
        '#size' => 10,
        '#element_validate' => [[$this, 'elementValidateNumber']],
        '#default_value' => isset($settings['maxZoomLevel']) ? $settings['maxZoomLevel'] : null,
      ...
      'navigatorOptions' => [
        ...
        'navigatorContainer' => [
          ...
          'navigatorTop' => [
            ...
            '#size' => 10,
            '#element_validate' => [[$this, 'elementValidateNumber']],
            '#default_value' => isset($settings['navigatorTop']) ? $settings['navigatorTop'] : null,
          ...
          'navigatorLeft' => [
            ...
            '#size' => 10,
            '#element_validate' => [[$this, 'elementValidateNumber']],
            '#default_value' => isset($settings['navigatorLeft']) ? $settings['navigatorLeft'] : null,
            '#description' => t('Specifies the location of the navigator minimap (see Navigator Position).'),
          ],
          'navigatorHeight' => [
            '#type' => 'textfield',
            ...
            '#size' => 10,
            '#element_validate' => [[$this, 'elementValidateNumber']],
            '#default_value' => isset($settings['navigatorHeight']) ? $settings['navigatorHeight'] : null,
          ...
          'navigatorWidth' => [
            ...
            '#size' => 10,
            '#element_validate' => [[$this, 'elementValidateNumber']],
            '#default_value' => isset($settings['navigatorWidth']) ? $settings['navigatorWidth'] : null,
            '#description' => t('Specifies the size of the navigator minimap (see Navigator Position). If specified, Navigator Size Ratio and Navigator Maintain Size Ratio are ignored.'),
          ],
          'navigatorAutoResize' => [
            '#type' => 'checkbox',
        ...
        'sequenceContainer' => [
          ...
          'referenceStripContainer' => [
            ...
            'referenceStripHeight' => [
              ...
              '#size' => 10,
              '#element_validate' => [[$this, 'elementValidateNumber']],
              '#default_value' => isset($settings['referenceStripHeight']) ? $settings['referenceStripHeight'] : null,
            ...
            'referenceStripWidth' => [
              ...
              '#size' => 10,
              '#element_validate' => [[$this, 'elementValidateNumber']],
              '#default_value' => isset($settings['referenceStripWidth']) ? $settings['referenceStripWidth'] : null,
